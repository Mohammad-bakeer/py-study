        ...
        if x == "y":
            ...
            if ytotal>21:
                ...
                if dtotal<17:                  
                    ...
                    dtotal=total_t(dcards)
                    if dtotal>21:
                        print(f"you win, your cards: {ycards}, your total: {ytotal}\n computers cards: {dcards}, copmputers total: {dtotal}")
                        cond2=False
            ...
            if ytotal>dtotal:
                ...
                print(f"Draw, your cards: {ycards}, your total: {ytotal}\n computers cards: {dcards}, copmputers total: {dtotal}")
            else:
                print(f"you lost, your cards: {ycards}, your total: {ytotal}\n computers cards: {dcards}, copmputers total: {dtotal}")    
